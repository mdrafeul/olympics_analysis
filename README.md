...
<p>In this project I tried to analysis olympics dataset from kaggle. The objective of the project is find the different kind of statistics about olypics. This project is divided into four parts i) Medal Tally, ii) Overall analysis, iii) Country-wise analysis and iv) Athletes-wise analysis. To properly visualize I used streamlit library.</p>
...
<p>In this last section <strong>Athletes-wise Analysis,</strong> I tried represent a line graph of <i>distribute of age</i> of wining medals, heigh vs weight medal wining ration in different sports.</p>
<img src='images/athlete-wise.PNG' width=650><br/> 
<img src='images/athlete-wise1.PNG' width=650><br/><br/> 
There are few others things are also analysied and presented in the app but my hearful appreciation for visiting this repo.
