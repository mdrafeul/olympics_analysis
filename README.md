# olympics_analysis
I tried to analyze the Olympics events dataset over the year.

## About

<p>In this project, I tried to analyze the Olympics dataset from Kaggle. The objective of the project is to find different kinds of statistics about the Olympics. This project is divided into four parts i) Medal Tally, ii) Overall analysis, iii) Country-wise analysis and iv) Athletes-wise analysis. To properly visualize I used streamlit library.</p>
...
There are a few other things that are also analyzed and presented in the app but my heartful appreciation for visiting this repo.
